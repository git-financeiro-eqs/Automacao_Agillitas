...
def aguardar():
    _ = esperar_aparecer(r'Imagens\TelaDeAguarde1.png')
    sleep(0.6)
    aguarde_final = encontrar_centro_imagem(r'Imagens\TelaDeAguarde3.png')
...
def aguardar1():
    aguarde = encontrar_imagem(r'Imagens\TelaDeAguarde1.png')
    while type(aguarde) == pyscreeze.Box:
        aguarde = encontrar_imagem(r'Imagens\TelaDeAguarde1.png')


def aguardar2():
    aguarde1 = encontrar_centro_imagem(r'Imagens\TelaDeAguarde1.png')
    aguarde2 = encontrar_centro_imagem(r'Imagens\TelaDeAguarde2.png')
    return aguarde1, aguarde2


def lancar_retroativo():
    lancamento_retroativo = encontrar_centro_imagem(r'Imagens\ReferenciaLancamentoRetroativo.png')
...
def tratar_etapa_final():
    x, y = clicar_2x(r'Imagens\BotaoSair.png')
    sleep(0.7)
    while True:
        ptg.moveTo(150,100)
        quebrar_loop = encontrar_centro_imagem(r'Imagens\ReferenciaQuebrarLoop.png')
...
def clicar_botao_sair():
    ...
    """
    botao_sair = encontrar_centro_imagem(r'Imagens\ReferenciaContingencialFinalizarESair.png')

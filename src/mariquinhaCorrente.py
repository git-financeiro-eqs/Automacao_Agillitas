...
def robozinho():
    ...
    controle_acao = utils.encontrar_centro_imagem(r'Imagens\ReferenciaParaAcao.png')
    ...
    ptg.moveTo(150,100)
    _ = utils.esperar_aparecer(r'Imagens\ReferenciaStatusPendenteTelaInicial.png')
                    ...
                    if type(aguardando) == tuple:
                        ...
                        try:
                            ...
                            try:
                                ...
                                ptg.press("enter", interval=1)
                                utils.repetir_botao()
                                clique_status = utils.esperar_aparecer(r'Imagens\ReferenciaStatus.png')  
                                x, y = clique_status
                                ptg.click(x, y)
                                sleep(0.7)
                                ptg.press("down")
            ...
            if estado_do_caixa == "NF já lançada":
                ...
                while type(tela_de_lancamento) != pyscreeze.Box:
                    ...
                    if type(erro_sefaz) == pyscreeze.Box or type(chave_divergente) == pyscreeze.Box:
                        ...
                        controle_de_repeticao.append(chave_de_acesso)
                        ptg.press("enter", interval=0.5)
                        _ = utils.esperar_aparecer(r'Imagens\ReferenciaBloqueioGenerico.png')
                        ptg.press("enter", interval=1)
                        utils.aguardar1()
                        erro_condicao_pag = utils.encontrar_centro_imagem(r'Imagens\ErroCondicaoDePagamento.png')
                        if type(erro_condicao_pag) == tuple:
